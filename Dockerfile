...
RUN if ["$WmCloudStreamsAnalytics" = true] ; then COPY /packages/wMPackages/WmCloudStreamsAnalytics /opt/softwareag/IntegrationServer/packages/WmCloudStreamsAnalytics; else echo WmCloudStreamsAnalytics not selected; fi
